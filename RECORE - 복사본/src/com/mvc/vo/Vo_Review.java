...
public class Vo_Review {
	...
	public Vo_Review(int prod_no, String prod_name, String prod_front_img, String acc_id, int order_no, int prod_id,
			String review_title, String review_content, int review_rate, Date review_regdate) {
		super();
	...
	public String toString() {
		return "Vo_Review [prod_no=" + prod_no + ", prod_name=" + prod_name + ", prod_front_img=" + prod_front_img
				+ ", acc_id=" + acc_id + ", order_no=" + order_no + ", prod_id=" + prod_id + ", review_title="
				+ review_title + ", review_content=" + review_content + ", review_rate=" + review_rate
