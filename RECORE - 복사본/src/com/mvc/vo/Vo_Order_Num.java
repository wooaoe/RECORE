...
public class Vo_Order_Num {
   ...
   public Vo_Order_Num(int order_no, int acc_no, String order_zipcode, String order_addr, String order_addr2,
         Date order_date, int order_point, List<Vo_Order> olist) {
      super();
   ...
   public List<Vo_Order> getOlist() {
      return olist;
   }


   public void setOlist(List<Vo_Order> olist) {
      this.olist = olist;
   }
