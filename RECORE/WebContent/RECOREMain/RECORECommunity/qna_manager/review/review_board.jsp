										...
										<c:otherwise>
											<c:forEach var="list" items="${list }" >
													<tr style="background-color: #FFFFFF; color: #555555;" class="xans-record-">
														<%-- <td class="title">${list.order_no}</td> --%>
														<%-- 리뷰 번호  --%>
														 <c:choose>
															<c:when test="${list.review_re_yn eq 'Y'}">
																<td class="title">&nbsp;</td>
															</c:when>
															<c:otherwise>
																<td class="title">${list.order_no}</td>
...
<%-- 														<td class="thumb left">
														...
														<c:choose>
															<c:when test="${list.review_re_yn eq 'N'}">
																<td  class="title">
																<a href="/product/아르지탈-민트-치약/303/"> <img src="" border="0" alt="">
																	<img style="width: 80px; height: 80px;" src="RECOREProduct/product/${list.prod_no }/${list.prod_front_img }.png">
																</a>
														...
														<td class="title">
															<img src="RECORECommunity/qna_manager/review/images/board/ico_point${list.review_rate }.gif">
														</td>
													</tr>
													<tr>
