...
$("#review_category").on('change',function() {
	//alert($("#review_category option:selected").val());
	location.href="qna.do?command=review_list&catd="+$("#review_category option:selected").val();
