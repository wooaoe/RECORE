					...
					<form id="boardWriteForm" action="qna.do" method="post">
						...
						<div class="xans-element- xans-board xans-board-write-4 xans-board-write xans-board-4">
								...
								<table summary="">
									...
									<tbody>
										<tr>
											...
											<td>
											<c:choose>
												<c:when test="${qnaVo.catd_no eq 14 }">
													배송문의
												</c:when>
												<c:when test="${qnaVo.catd_no eq 15 }">
													취소/교환/환불문의
												</c:when>
												<c:otherwise>
													상품문의
							...
							<div class="ec-base-button ">
								<span class="gLeft"> 
									<input class="btnNormalFix sizeS" type="button" value="목록" onclick="location.href='qna.do?command=qna_list'">
								</span> 
								<span class="gRight"> 
									<input id="save" class="btnNormalFix sizeS" type="button" value="수정">
									<input class="btnBasicFix sizeS" type="button" value="취소" onclick="location.href='qna.do?command=qna_list'">
								</span>
							</div>
						</div>
