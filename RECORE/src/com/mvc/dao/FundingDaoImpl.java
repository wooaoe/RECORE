...
public class FundingDaoImpl implements FundingDao {
	...
	public boolean F_insert(Vo_Funding_Payment fvo) {
		...
		try {
			...
			String sql2 = prop.getProperty("totalFundingPayment");
			String sql3 = prop.getProperty("fundingSOF");
			...
			pstmt.setInt(1, fvo.getFpm_price());
			pstmt.setString(2, fvo.getFpm_card_name());
			pstmt.setString(3, fvo.getFpm_card_pw());
			pstmt.setString(4, fvo.getFpm_card_valid());
			pstmt.setString(5, fvo.getFpm_card_cvc());
