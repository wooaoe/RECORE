...
public class FundingDaoImpl implements FundingDao {
	...
	public boolean F_insert(Vo_Funding fvo) {
		...
		try {
			...
			pstmt.setString(1, fvo.getFund_title());
			pstmt.setString(2, fvo.getFund_creator());
			pstmt.setString(3, fvo.getFund_content());
			pstmt.setInt(4, fvo.getFund_target_price());
			pstmt.setDate(5, fvo.getFund_deadline());
	...
	@Override
	public List<Vo_Funding> Child_selectAll(int pseq) {
		// TODO Auto-generated method stub
		return null;
	}
