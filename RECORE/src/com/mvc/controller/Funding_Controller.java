...
public class Funding_Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("selectAllFunding")) {
			...
			Vo_Funding fvo = dao.F_selectOne(f_seq);
			
			System.out.println(fvo);
			
			String newpath = request.getServletContext().getRealPath("RECOREMain\\RECOREFunding\\images\\"+fvo.getFund_no());
			...
			int iseq = Integer.parseInt(request.getParameter("fund_no"));
			
			boolean res = dao.F_delete(iseq);
			...
			if(res) {
				...
				jsResponse("삭제에 실패하였습니다.", "funding.do?command=selectOneFunding&fund_no="+iseq+"&pageno="+"", response);
