				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="xans-element- xans-board xans-board-listpackage-1002 xans-board-listpackage xans-board-1002 ">
						...
						<div class="review_menuCategory">
							<ul class="">
								<li value="all" class="selected"><a >전체<span class="bar"></span></a></li>
								<li value="product" class=""><a >상품문의<span class="bar"></span></a></li>
								<li value="delivery" class=""><a >배송문의<span class="bar"></span></a></li>
										...
										<c:otherwise>
											<c:forEach var="list" items="${list }" >
													<tr style="background-color: #FFFFFF; color: #555555;" class="xans-record-">
														...
														href="/product/아르지탈-민트-치약/303/"><img
															src=""
															border="0" alt=""><span>[아르지탈] 민트 치약</span></a></td>
														...
														<td  class="title"><span class="txtNum">${list.qna_view_count }</span></td>
