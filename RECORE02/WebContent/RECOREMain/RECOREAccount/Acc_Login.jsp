	...
	<div>
		<section class="container">
			<article class="half">
				<h1>로그인</h1>
				<div class="tabs">
					<span class="tab signin active"><a href="../index.html">sign
							in</a></span>
				</div>
					...
					<div class="signin-cont cont">
						<form action="../../Account_Controller.do?command=login" method="post" id="loginForm" name="loginForm">
							...
							<div class="submit-wrap" style=margin-top:15px;>
								<input type="submit" value="로그인" style="text-align: center; margin-bottom: 15px;" class="submit"> <span class="tab signup active">
<!-- 							<input type="checkbox" id="remember" class="checkbox" checked>
						        <label for="remember">아이디 저장</label> -->
								<a href="<%=apiURL%>" ><img width="200" style="margin-top: 15px;" src="<%=request.getContextPath()%>/RECOREMain/RECOREAccount/Accimages/login.PNG"/></a>
								<a href="Acc_Signup.jsp" style="margin-top: 15px;">회원가입</a></span> 
