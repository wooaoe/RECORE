<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="site-mobile-menu">
 	 ...
 	 <div class="site-navbar-wrap" style="position: static; background-color: #F25430;">
      <div class="site-navbar-top">
        <div class="container py-3">
        
           <!-- @@@로고 위치 @@@-->
        <br>
        <div style = "text-align: center;"><a href = "../index.html"><img alt="" src = "Accimages/donut.png"></a></div>
