...
public class Community_QnA_Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("qna_list")) {
			...
			/*
			 * JSONObject obj = new JSONObject(); obj.put("qna_view_count",
			 * qnaVo.getQna_view_count()); obj.put("qna_no", qna_no); PrintWriter out =
			 * response.getWriter(); out.println(obj.toJSONString());
			 */
			...
			if (res) {
				jsResponse("글 작성이 완료되었습니다.", "qna.do?command=qna_list", response);
			} else {
				jsResponse("글 작성에 실패하였습니다. 다시 시도해주세요.", "qna.do?command=qna_list", response);
			}
			...
			if (res) {
				jsResponse("글 수정이 완료되었습니다.", "qna.do?command=qna_list", response);
			} else {
				jsResponse("글 수정에 실패하였습니다. 다시 시도해주세요.", "qna.do?command=qna_list", response);
			}
