...
public class Vo_Wish {
	...
	public Vo_Wish(int prod_no, int acc_no, String prod_front_img, String prod_brand, String prod_name,
			int prod_price) {
		super();
	...
	public String toString() {
		return "Vo_Wish [prod_no=" + prod_no + ", acc_no=" + acc_no + ", prod_front_img=" + prod_front_img
				+ ", prod_brand=" + prod_brand + ", prod_name=" + prod_name + ", prod_price=" + prod_price + "]";
	}
