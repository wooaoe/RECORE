...
<html lang="en">
  <head>
    <title>RECORE &mdash; OUTER</title>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
			...
			<!--@@ 이미지 들어가는 곳 @@-->          
           <c:forEach var="outer" items = "${outlist}">
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="Product.do?command=ProdDetail&pseq=${outer.prod_no}" class="d-block figure">
            <%-- <%=request.getContextPath()%> --%>
              <img id = "img-fluid" src="<%=request.getContextPath()%>/RECOREMain/RECOREProduct/product/${outer.prod_no}/f_img.png" alt="Image" class="img-fluid"> 
            </a>
            <h3 class="mb-0"><a href="Product.do?command=ProdDetail&pseq=${outer.prod_no}">${outer.prod_name}</a></h3>
            <span class="text-muted">${outer.prod_brand}</span><br>
            <span class = "mb-0"><b><fmt:formatNumber value="${outer.prod_price}" groupingUsed="true"></fmt:formatNumber>원</b></span>
          	<br><br>
          </div>
          </c:forEach>
