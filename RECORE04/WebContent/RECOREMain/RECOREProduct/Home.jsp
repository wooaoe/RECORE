      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="Product.do?command=ProdDetail&pseq=${home.prod_no}" class="d-block figure">
            <%-- <%=request.getContextPath()%> --%>
              <img id = "img-fluid" src="<%=request.getContextPath()%>/RECOREMain/RECOREProduct/product/${home.prod_no}/f_img.png" alt="Image" class="img-fluid"> 
            </a>
            <h3 class="mb-0"><a href="Product.do?command=ProdDetail&pseq=${home.prod_no}">${home.prod_name}</a></h3>
            <span class="text-muted">${home.prod_brand}</span><br>
            <span class = "mb-0"><b><fmt:formatNumber value="${home.prod_price}" groupingUsed="true"></fmt:formatNumber>원</b></span>
          	<br><br>
          </div>
          </c:forEach>
