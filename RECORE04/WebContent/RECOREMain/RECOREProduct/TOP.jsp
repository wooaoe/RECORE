      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="Product.do?command=ProdDetail&pseq=${top.prod_no}" class="d-block figure">
            <%-- <%=request.getContextPath()%> --%>
              <img id = "img-fluid" src="<%=request.getContextPath()%>/RECOREMain/RECOREProduct/product/${top.prod_no}/f_img.png" alt="Image" class="img-fluid"> 
            </a>
            <h3 class="mb-0"><a href="Product.do?command=ProdDetail&pseq=${top.prod_no}">${top.prod_name}</a></h3>
            <span class="text-muted">${top.prod_brand}</span><br>
            <span class = "mb-0"><b><fmt:formatNumber value="${top.prod_price}" groupingUsed="true"></fmt:formatNumber>원</b></span>
          </div>
          </c:forEach>
