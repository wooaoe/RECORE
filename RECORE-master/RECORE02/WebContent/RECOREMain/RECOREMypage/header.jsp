            ...
            <div class="col-6">
              <div class="d-flex ml-auto">
               ...
               <form id="search" method="get" action="#" class="d-flex align-items-center ml-auto mr-4">
              	...
              	<c:if test="${empty vo }">
                <a href="/RECORE02/RECOREMain/RECOREAccount/Acc_Login.jsp" class="d-flex align-items-center">
                 <span class="d-none d-md-inline-block" style="color:black;">로그인 &nbsp;&nbsp;</span>
                 </a>
                 
                 <a href="/RECORE02/RECOREMain/RECOREAccount/Acc_Signup.jsp" class="d-flex align-items-center">
                ...
                <c:if test="${!empty vo }">
    				...
    				<a href="/RECORE02/RECOREMain/RECOREMypage/Mypage_Main.jsp" class="d-flex align-items-center">
    				<span class="d-none d-md-inline-block" style="color:black;">마이페이지&nbsp;&nbsp;</span></a>
    				<a href="/RECORE02/RECOREMain/RECOREMypage/Mypage_Cart.jsp" class="d-flex align-items-center">
                    <span class="d-none d-md-inline-block" style="color:black;">장바구니</span></a>
    			</c:if>  
